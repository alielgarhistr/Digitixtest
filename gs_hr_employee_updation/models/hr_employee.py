...
class HrEmployee(models.Model):
    ...
    passport_issuer = fields.Char(string='Issuer')
    ...
    expiry_border_number_date = fields.Date(string='Expiry Date', help='Expiry date of Border Number')
    ...
    def onchange_spouse(self):
        relation = self.env.ref('gs_hr_employee_updation.employee_relationship')
        lines_info = []
