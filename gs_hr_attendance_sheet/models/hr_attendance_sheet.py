...
class AttendanceSheet(models.Model):
    ...
    def _compute_sheet_total(self):
        ...
        for sheet in self:
            ...
            for line in absence_lines:
                if line.date not in processed_dates:
                    processed_dates.add(line.date)
                    unique_absence_lines.append(line.diff_time)
    ...
    def action_payslip(self):
        ...
        if not payslip_id:
            ...
            print('inside : action_payslip , there is no paysip so created one')
        print(payslip_id)
        print(payslip_id)
        print('inside the button action_payslip')
        return {
    ...
    def action_create_payslip(self):
        ...
        print('inside action_create_payslip : that means he is trying to create payslip')
        for sheet in self:
    ...
    def create_payslip(self):
        print('create payslip function , I think it is not used')
        print('NOt Used !!!')
